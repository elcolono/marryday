...
import data from "./user-personal.json"
                                ...
                                <Collapse isOpen={personalCollapse}>
                                    <Formik
                                        ...
                                        onSubmit={(values, { setSubmitting }) => {
                                            fetchAPI(`/api/v1/profiles/company/${company.id}/`, { method: 'PUT', body: values }).then(response => {
                            ...
                            <div className="text-block">
                                ...
                                <Collapse isOpen={addressCollapse}>
                                    <Formik
                                        ...
                                        onSubmit={(values, { setSubmitting }) => {
                                            fetchAPI(`/api/v1/accounts/user/${user.id}/`, { method: 'PUT', body: values }).then(response => {
                                                toast.success("Erfolgreich gespeichert");
                                                setUser(response);
                                                setSubmitting(false);
                                            }).catch(error => {
...
export const getServerSideProps: GetServerSideProps = async ({ params, req, res, }) => {
    ...
    const companies = await fetchAPIwithSSR('/api/v1/profiles/usercompanies/', { method: 'GET', req: req }) ?? {}
